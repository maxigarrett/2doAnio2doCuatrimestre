...
<!--  3- perdirle al usuario patente,color y modelo y añadir al finalde un archivo de texto llamado "patente.txt"
(en modo append)
 -->
 ...
 <% 
 	...
 	try
 	{
 		FileWriter archivo=new FileWriter("C:/segundo año segundo cuatrimestre/tec java eclipse/tpParametrosJsp.txt");
